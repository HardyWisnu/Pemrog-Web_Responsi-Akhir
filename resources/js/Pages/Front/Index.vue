...
import WatermelonJSON from "/public/img/animation_lk0y7o9r.json";
    ...
    <nav class="bg-white">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
                <img src="img/Annotation_2023-05-10_092157-removebg-preview.png" class="h-8 mr-3" alt=" Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-dark">Hardy kah</span>
            </a>
                ...
                <div v-if="canLogin">
                    ...
                    <template v-else>
                        <Link :href="route('login')" type="button"
                            class="text-white bg-pink-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 bg-pink-500 dark:hover:bg-orange-200 dark:focus:ring-blue-800">
                        Log in</Link>
                    </template>
                </div>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-dark bg-pink-500 rounded md:bg-transparent md:text-pink-500 md:p-0 dark:text-dark md:dark:text-pink-500"
                            aria-current="page">Home</a>
                    </li>
                    <li>
                        <a href="#about"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-pink-500 md:p-0 dark:text-dark md:dark:hover:text-pink-500 dark:hover:bg-pink-500 dark:hover:text-dark md:dark:hover:bg-transparent">About</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-pink-500 md:p-0 dark:text-dark md:dark:hover:text-pink-500 dark:hover:bg-pink-500 dark:hover:text-dark md:dark:hover:bg-transparent">Services</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-pink-500 md:p-0 dark:text-dark md:dark:hover:text-pink-500 dark:hover:bg-pink-500 dark:hover:text-dark md:dark:hover:bg-transparent">Pricing</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-pink-500 md:p-0 dark:text-dark md:dark:hover:text-pink-500 dark:hover:bg-pink-500 dark:hover:text-dark md:dark:hover:bg-transparent">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
    </nav>
    <section class="bg-white dark:bg-pink-500">
        <div class="py-1 px-4 mx-auto max-w-screen-xl  lg:py-16 grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div class="flex flex-col justify-center rounded-lg">
                <h1
                    class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-orange-200">
                    Welcome {{ slider.judul }}</h1>
                <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl dark:text-white">
                    {{ slider.konten }}</p>
                <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 ">
                    <a href="#"
                        class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center rounded-lg bg-orange-200 hover:bg-pink-300 focus:ring-4 focus:ring-orange-200 dark:focus:ring-orange-200">
                    ...
                    <a href="#"
                        class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-orange-200 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                        Learn more </a>
                </div>
            </div>
            <div>
    ...
    <section cclass="bg-grey-50" id="about">
        <div class="mx-auto max-w-screen-xl container flex flex-col items-center py-16 md:py-20 lg:flex-row">
            <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                <h2 class="font-header text-4xl font-semibold uppercase text-primary sm:text-5xl lg:text-6xl"> Sopo hayo?
                </h2>
                ...
                <p class="pt-6 font-body leading-relaxed text-grey-20">Saran saya jangan diklick(;)</p>
                <div class="flex flex-col justify-center pt-6 sm:flex-row lg:justify-start">
                    <div class="flex items-center justify-center sm:justify-start">
                        <a href="https://www.halodoc.com/artikel/sering-pusing-mungkin-terkena-5-penyakit-ini"
                            class="font-body text-lg font-semibold uppercase text-grey-20"> Pusing Dikit </a>
                ...
                <div class="flex items-center justify-center sm:justify-start">
                    <img src="img/discord-logo-discord-icon-transparent-free-png.webp" class="h-8 mr-3" alt=" Logo" />   
                    <a href="https://discord.com/users/256634698405511169"
                            class="font-body text-lg font-semibold uppercase text-grey-20"> Discord </a>
                        <div class="hidden sm:block">
                            <i class="bx bx-chevron-right text-2xl text-primary"></i>
                        </div>
                    </div>
            ...
            <div class="w-full pl-0 pt-10 sm:w-3/4 lg:w-2/5 lg:pl-12 lg:pt-0">
                <div v-for="item in skill" :key="item.id">
                    ...
                    <div class="mt-2 bg-lila w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                        <div class="bg-pink-500 h-2.5 rounded-full" style="width: {{item.konten}}%"></div>
                    </div>
                </div>
            </div>
        </div>
